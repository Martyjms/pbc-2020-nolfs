...
@section('content')
    {{-- ||  Two Column Section || --}}
        ...
        <h2 class="cov text-center">COVID-19 UPDATE: May 4th 2020</h2>
        ...
        <p class="lead cov">We had hoped that restrictions would have been lifted sooner, but because
        ...
        <p class="lead cov">We hope you continue to stand firm in your faith. We will miss seeing your faces
        ...
        <p class="lead cov">Within the next weeks we will be reimbursing all registrations and tuck fees.
            Thank you for your patience as this process will take time.</p>
        <p class="lead cov">Thank you for your support and understanding. If you have any further questions
            please don’t hesitate to contact me. Till then we look forward to seeing you next
            summer.</p>
        <p class ="lead cov">Sincerely,</p>
        <p class ="lead cov">Kenton Giesbrecht,</p>
        <p class ="lead cov">Camp Director</p>
        </div>
